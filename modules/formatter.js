...
exports.formatLoanAccountLinking = () =>{
    return {
        "attachment": {
            ...
            "payload": {
                "template_type": "button",
                "text":"Happy to, but before I can provide you with the status, could you click below to authenticate yourself? Since this is a demo, use username 'borrower@mmaster.demo' and password 'salesforce5'",
                "buttons": [
                    {  
                    "type":"account_link",
                    "url":"https://mortgagecommunitydemo-15801ffe7f4.force.com/realtors/FBCommunitiesLoginPage?startURL=FBRedirect&function=loanstatus"
                    }
                ]
            }
        }
...
exports.contactLoanOfficer = () => {
     return {
            "attachment": {
                ...
                "payload": {
                    "template_type": "button",
                    "text": "Unfortunately, due to compliance, I am unable to share that information with you here. Do you want me to ask a loan officer to contact you?",
                    "buttons": [
                        {
                            "type": "postback",
                            "title": "Contact Loan Officer",
